  ...
  <div class="row q-col-gutter-sm  q-py-sm">
    ...
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
      <q-card class="q-ma-xs" style="background-color: #ea4b64">
        <!-- <q-card-section class="text-h8 text-white">
          Daily Diet
        </q-card-section> -->
        <q-card-section class="q-pa-none">
          <IEcharts style="height: 120px" :option="BarChart" :resizable="true"/>
        </q-card-section>
      </q-card>
    </div>
    <!-- <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
  ...
  data () {
    return {
      BarChart: {
        ...
        "dataset": {
            "source": [{"label": "0D", "max": 100, "weight": 78}, {
                "label": "1D",
                "max": 100,
                "weight": 77
            }, {"label": "2D", "max": 100, "weight": 76}, {
                "label": "3D",
                "max": 100,
                "weight": 75
            }, {"label": "4D", "max": 100, "weight": 74}, {
                "label": "5D",
                "max": 100,
                "weight": 73
            }, {"label": "6D", "max": 100, "weight": 73}, {
                "label": "7D",
                "max": 100,
                "weight": 73
            }, {"label": "8D", "max": 100, "weight": 73}, {
                "label": "9D",
                "max": 100,
                "weight": 73
            }, {"label": "10D", "max": 100, "weight": 70}, {
                "label": "11D",
                "max": 100,
                "weight": 70
            }, {"label": "12D", "max": 100, "weight": 70}, {
                "label": "13D",
                "max": 100,
                "weight": 70
            }, {"label": "14D", "max": 100, "weight": 70}, {
                "label": "15D",
                "max": 100,
                "weight": 70
            }, {"label": "16D", "max": 100, "weight": 70}, {
                "label": "17D",
                "max": 100,
                "weight": 70
            }, {"label": "18D", "max": 100, "weight": 70}, {"label": "19D", "max": 100, "weight": 70}]
        }
    },
    LineChart: {
        "tooltip": {"show": true},
