<template>
  <q-page class="q-pa-sm">  
    <div style="max-width: 800px; width: 100%;">
        <CardChartsLine :line="bodyWeightList"/>
    </div>
...
export default {
  ...
  beforeCreate: async function () {
    console.log('beforecreate')
      ...
      this.sortWeight = this.sortByDate(this.userWeight)
    console.log('sort', this.sortWeight)


    this.bodyWeightList = { 
      "dataset": {
        "source": this.sortWeight
      }
    }
  ...
  methods: {
    ...
    sortByDate (weight) {
      ...
      return weight.sort((a, b) => a.weightdate - b.weightdate).reverse()
    },
    setWeight () {
      this.bodyWeightList = { 
      "dataset": {
        "source": this.sortWeight
        // [
        //   {"weightdate": "2021/02/01", "weight": 70},
        //   {"weightdate": "2021/02/02", "weight": 70},
        //   {"weightdate": "2021/02/03", "weight": 70},
        //   {"weightdate": "2021/02/04", "weight": 70},
        //   {"weightdate": "2021/02/05", "weight": 70},
        // ]
      }
    }
    }
